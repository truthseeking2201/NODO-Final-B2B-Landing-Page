    ...
    <section className={SECTION_SPACING_CLASS} id="architecture">
      <div className={`${CONTAINER_CLASS} space-y-12`}>
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex w-full max-w-3xl flex-col gap-6 rounded-[24px] bg-white px-6 py-5 text-black sm:flex-row sm:items-center sm:justify-between sm:rounded-full">
